# CORREGIMOS EL ERROR DE ASIGNACIÓN DE PÁGINA OBTENIENDO EL DIRECTORIO ACTUAL ANTES DE VERIFICAR
# SEPARAMOS LA FUNCIÓN READ_AND_OPEN_HTML EN 2
...
class CDN:
    ...
    def get_content(self, url):
        if url in self.cache:
            ...
            if time.time() - timestamp < self.cache_expiration:
                ...
                self.access_times[url] = time.time()  # Actualiza el tiempo de acceso
    ...
    def evict_cache(self):
        # Desalojar la entrada de caché utilizada menos recientemente (LRU)
...
def main():
    cdn = CDN(max_cache_size=5, cache_expiration=20)  # Crea una instancia de la clase CDN con tamaño máximo de caché y expiración
    while True:
