# Versión 2: Mejora con gestión de prioridades
# Implementación con gestión de prioridades en los mensajes publicados

class NotificationSystem: # Clase para gestionar temas y suscripciones con soporte para prioridades en mensajes
    def __init__(self):
